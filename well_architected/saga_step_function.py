from aws_cdk import (
    ...
    aws_stepfunctions_tabooking_types as step_fn_tabooking_types,
    core as cdk
)
...
class SagaStepFunction(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, id: str, **kwargs) -> None:
        ...
        # 1) Reserve Flights and Hotel
        cancel_hotel_reservation = step_fn_tabooking_types.LambdaInvoke(
        ...
        reserve_hotel = step_fn_tabooking_types.LambdaInvoke(
            self, 'ReserveHotel',
        ...
        cancel_flight_reservation = step_fn_tabooking_types.LambdaInvoke(
        ...
        reserve_flight = step_fn_tabooking_types.LambdaInvoke(
            self, 'ReserveFlight',
        ...
        # 2) Take Payment
        refund_payment = step_fn_tabooking_types.LambdaInvoke(
            self, 'RefundPayment',
        ...
        take_payment = step_fn_tabooking_types.LambdaInvoke(
            self, 'TakePayment',
        ...
        # 3) Confirm Flight and Hotel Booking
        confirm_hotel = step_fn_tabooking_types.LambdaInvoke(
        ...
        confirm_flight = step_fn_tabooking_types.LambdaInvoke(
            self, 'ConfirmFlight',
