...
class SqsFlow(Stack):
    ...
    def create_lambda_function(self, function_name=None, environment_variables=None):
    ...
    def create_sqs_publisher(self, sqs_queue: Queue=None, sns_topic: ITopic=None):
        sqs_publisher = self.create_lambda_function(
            function_name="sqs",
    ...
    def create_sqs_subscriber(self, sqs_queue: Queue=None):
        sqs_subscriber = self.create_lambda_function(function_name="sqs_subscribe")
