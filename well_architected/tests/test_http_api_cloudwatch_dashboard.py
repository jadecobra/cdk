...
class TestHTTPAPICloudWatchDashboard(TestTemplates):
  ...
  "Resources": {
    "APIGateway4XXErrors1647FE3DB": {
      ...
      "Metadata": {
        "aws:cdk:path": "HttpApiCloudWatchDashboard/API Gateway 4XX Errors > 1%/Resource"
      }
    },
    "APIGateway5XXErrors0A91D7B4E": {
      ...
      "Metadata": {
        "aws:cdk:path": "HttpApiCloudWatchDashboard/API Gateway 5XX Errors > 0/Resource"
      }
    },
    "APIp99latencyalarm1s67095ACE": {
      ...
      "Metadata": {
        "aws:cdk:path": "HttpApiCloudWatchDashboard/API p99 latency alarm >= 1s/Resource"
      }
    },
    "DynamoLambda2ErrorDE3BEB2F": {
      ...
      "Metadata": {
        "aws:cdk:path": "HttpApiCloudWatchDashboard/Dynamo Lambda 2% Error/Resource"
      }
    },
    "DynamoLambdap99LongDuration1s739ED568": {
      ...
      "Metadata": {
        "aws:cdk:path": "HttpApiCloudWatchDashboard/Dynamo Lambda p99 Long Duration (>1s)/Resource"
      }
    },
