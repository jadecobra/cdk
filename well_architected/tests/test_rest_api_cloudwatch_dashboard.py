...
class TestRestAPICloudWatchDashboard(TestTemplates):
  ...
  "Resources": {
    "theBigFanTopicF96567DE": {
      "Type": "AWS::SNS::Topic",
      "Metadata": {
        "aws:cdk:path": "RestApiCloudWatchDashboard/theBigFanTopic/Resource"
      }
    },
    ...
    "DynamoLambda2ErrorDE3BEB2F": {
      ...
      "Metadata": {
        "aws:cdk:path": "RestApiCloudWatchDashboard/Dynamo Lambda 2% Error/Resource"
      }
    },
    "DynamoLambdap99LongDuration1s739ED568": {
      ...
      "Metadata": {
        "aws:cdk:path": "RestApiCloudWatchDashboard/Dynamo Lambda p99 Long Duration (>1s)/Resource"
      }
    },
    "DynamoLambda2Throttled090CFA4C": {
      ...
      "Metadata": {
        "aws:cdk:path": "RestApiCloudWatchDashboard/Dynamo Lambda 2% Throttled/Resource"
      }
    },
    "DynamoDBTableReadsWritesThrottled13F6F2AE": {
      ...
      "Metadata": {
        "aws:cdk:path": "RestApiCloudWatchDashboard/DynamoDB Table Reads--Writes Throttled/Resource"
      }
    },
