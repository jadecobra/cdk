...
class TestDynamoDBTable(TestTemplates):
  ...
  "Resources": {
    ...
    "CDKMetadata": {
      ...
      "Properties": {
        "Analytics": "v2:deflate64:H4sIAAAAAAAA/0VOSwqDMBA9S/cxNrjpssUeoGgvME4ipuoM5INIyN3rB9rV+/J4SqrqJtXlDosvUI9lQnZGpjYAjqIxnqNDI2omH1zEIOqe/m5PW6BtsExZ7AtJrwQz606mN3TTUTlIFjhx1AsEHGR6TODmPTvJE/zQMTi9Wz+RcxavNQxMZSXVdTv58dYWLlKws5HNiV/yufgdwQAAAA=="
      },
      "Metadata": {
